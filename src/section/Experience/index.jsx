...
const Experience = () => {
    ...
    return (
        <div className="">
            ...
            >
                <div>
                    <FormattedDate isHighlight={isMouseEnter['exp1']}>2024-2029</FormattedDate>
                    <Picture picture={picExp} title="Fullstack" />
                </div>
                <div className="grid gap-y-4">
                    <TitleLink isHighlight={isMouseEnter['exp1']} title="Fullstack" link="https://github.com/RisuMao/react101" />
                    <div className="flex gap-4 text-xl" >
                        <Material icon={faGithub} link="https://github.com/RisuMao/react101" />
                        <Material icon={faYoutube} link="https://www.youtube.com" />
                    </div>
